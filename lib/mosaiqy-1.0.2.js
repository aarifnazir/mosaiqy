 ...
 * (CC BY-ND 3.0) available atemplatet http://creativecommons.org/licenses/by-nd/3.0/
...
(function($) {
    ...
    /**
     * jQuery.sub, taken from jQuery migrate plugin 
     */
    $.sub = function() {
    ...
    GPUAcceleration = (function() {
        ...
        return {
            ...
            transitionEnd   : 'oTransitionEnd webkitTransitionEnd transitionend'
        };
    }()),
    ...
    Mosaiqy = function($) {
        ...
        _thumbSize          = {},
        _page               = $('html:not(:animated), body:not(:animated)'),
        _intvAnimation,
         ...
         */ 
        _setNodeZoomEvent   = function(nodeparent) {
             ...
             * injected at every animation cycle, event delegation on node parent is needed.
             */
            nodeparent.on('click.mosaiqy', 'li:not(.mosaiqy-zoom)', function(evt) {
        ...
        return {
            ...
            init    : function(cnt, options) {
                ...
                if (!!_s.template && $("#" + _s.template).is('script')) {
                    ...
                    _s.template = _s.template.replace(/^\s+|\s+$/, "");
                }
                else {
        ...
        animate     : function(props, speed, easing, callback) {
            ...
            return $(this).each(function() {  
                ...
                if (GPUAcceleration.isEnabled) {
                    ...
                    $this.on(GPUAcceleration.transitionEnd, function() {
